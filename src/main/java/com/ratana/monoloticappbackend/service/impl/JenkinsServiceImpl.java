...
public class JenkinsServiceImpl implements JenkinsService {
    ...
    @Override
    public void triggerBuild(String repoUrl, String branch, String appName, int appPort, String userId) {
        String url = jenkinsUrl + "/job/deploy-pipeline/buildWithParameters" +
                ...
                "&APP_PORT=" + appPort +
                "&USER_ID=" + UriUtils.encode(userId, StandardCharsets.UTF_8);
        ...
        ResponseEntity<String> response = rest.postForEntity(url, new HttpEntity<>(headers), String.class);
